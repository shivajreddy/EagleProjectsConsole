...
async function get_curr_usr() {
  ...
  columnDefs.push(
      ...
      children: [
        {
          ...
          sortable: true,
          filter: true,
          headerTooltip: "Drafter Name",
          width: 100,
        },
        {
          headerName: "Draft Deadline",
          field: "draft_deadline",
          sortable: true,
          filter: true,
          headerTooltip: "Drafting-Deadline Date",
          width: 120,
          cellStyle: (params) => {
        ...
        },
        {
          ...
          filter: true,
          columnGroupShow: "open",
          headerTooltip: "Actual Finished Date",
          width: 120,
        },
        {
          headerName: "Time",
          ...
          filter: true,
          columnGroupShow: "open",
          headerTooltip: "Total Time in minutes",
          width: 120,
        },
      ],
    },
      ...
      children: [
        {
          ...
          sortable: true,
          filter: true,
          headerTooltip: "Engineering Name",
        },
        {
          headerName: "Eng. Sent",
          field: "eng_sent",
          ...
          filter: true,
          columnGroupShow: "open",
          headerTooltip: "Engineering Sent Date",
          width: 120,
        },
        {
          headerName: "Eng. Planned Receipt",
          field: "eng_planned_receipt",
          sortable: true,
          filter: true,
          headerTooltip: "Engineering Planned Receipt Date",
          width: 120,
          cellStyle: (params) => {
            if (
              params.data.eng_actual_receipt === "None" ||
              params.data.eng_actual_receipt === ""
            ) {
              return color_code(params.value);
            } else {
              return style_none;
        ...
        {
          headerName: "Eng. Actual Receipt",
          field: "eng_actual_receipt",
          sortable: true,
          filter: true,
          columnGroupShow: "open",
          headerTooltip: "Engineering Actual Receipt Date",
          width: 120,
        },
      ],
    },
    ...
    //! Plat
    {
      ...
      children: [
        {
          headerName: "Plat Engineering",
          field: "plat_eng",
          sortable: true,
          filter: true,
          headerTooltip: "Plat Engineering Name",
        },
        {
          headerName: "Plat Sent",
          field: "plat_sent",
          sortable: true,
          filter: true,
          columnGroupShow: "open",
          headerTooltip: "Plat Sent Date",
          width: 120,
        },
        {
          headerName: "Plat Planned Receipt",
          field: "plat_planned_receipt",
          sortable: true,
          filter: true,
          headerTooltip: "Plat Planned Receipt Date",
          width: 120,
          cellStyle: (params) => {
            if (
              params.data.plat_actual_receipt === "None" ||
              params.data.plat_actual_receipt === ""
            ) {
              return color_code(params.value);
            } else {
              return style_none;
        ...
        {
          headerName: "Plat Actual Receipt",
          field: "plat_actual_receipt",
          sortable: true,
          filter: true,
          columnGroupShow: "open",
          headerTooltip: "Plat Actual Receipt Date",
          width: 120,
        },
      ],
    },
    ...
    //! Permit
    {
      ...
      children: [
        {
          headerName: "Permit Jurisdiction",
          field: "permit_jurisdiction",
          sortable: true,
          filter: true,
          headerTooltip: "Jurisdiction Name",
        },
        {
          headerName: "Permit Planned Submit",
          field: "permit_planned_submit",
          sortable: true,
          filter: true,
          headerTooltip: "Permit Planned Submit Date",
          width: 120,
          cellStyle: (params) => {
            if (
              params.data.permit_actual_submit === "None" ||
              params.data.permit_actual_submit === ""
            ) {
              return color_code(params.value);
            } else {
              return style_none;
        ...
        {
          headerName: "Permit Actual Submit",
          field: "permit_actual_submit",
          sortable: true,
          filter: true,
          columnGroupShow: "open",
          headerTooltip: "Permit Actual Submit Date",
          width: 120,
        },
        {
          headerName: "Permit Received",
          field: "permit_received",
          sortable: true,
          filter: true,
          columnGroupShow: "open",
          headerTooltip: "Permit Received Date",
          width: 120,
        },
      ],
    },
    ...
    //! BBP
    {
      ...
      children: [
        {
          headerName: "BBP Planned Posted",
          field: "bbp_planned_posted",
          sortable: true,
          filter: true,
          headerTooltip: "BBP Planned Posted Date",
          width: 120,
          cellStyle: (params) => {
            if (
              params.data.bbp_actual_posted === "None" ||
              params.data.bbp_actual_posted === ""
            ) {
              return color_code(params.value);
            } else {
              return style_none;
        ...
        {
          headerName: "BBP Actual Posted",
          field: "bbp_actual_posted",
          sortable: true,
          filter: true,
          columnGroupShow: "open",
          headerTooltip: "BBP Actual Posted Date",
          width: 120,
        },
      ],
    },
...
function syncLocalStorage() {
  const key = "local-ui-prefs";
  var local_ui_prefs;
  const existing_prefs = localStorage.getItem(key);
  if (existing_prefs) {
    local_ui_prefs = JSON.parse(existing_prefs);
  }
}

syncLocalStorage();
// gridOptions.columnDefs[1].children[0].pinned = "left";
